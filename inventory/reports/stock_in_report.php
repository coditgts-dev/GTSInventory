...
$logs = $db->select("
    SELECT c.category_name, i.item_code, i.item_name, l.quantity, l.created_at, u.person_name
    FROM inventory_logs l
    JOIN items i ON i.id=l.item_id
    JOIN categories c ON c.id=i.category_id
    JOIN users u ON u.id=l.user_id
    WHERE l.action='IN' AND DATE(l.created_at) BETWEEN '$from' AND '$to'
...
<meta name="description" content="Stock IN report for inventory system">
...
<div class="container-fluid py-5">
  <h4 class="mb-3 text-primary">Stock IN Report</h4>
        ...
        buttons: [
            {
                ...
                customize: function(csv){
                    // Optional: add total quantity at the bottom
                    let totalQty = 0;
